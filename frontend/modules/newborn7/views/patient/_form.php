...
<div class="patient-form">
    ...
    <fieldset>
        <div class="row">
            ...
            <div class="col-md-3 col-xs-12">
                <div class="form-group field-patient-hospcodeName">
                    ...
                    <input type="text" id="patient-hospcodeName"
                           value="<?= isset(Yii::$app->user->identity->profile->hospital) ? Yii::$app->user->identity->profile->hospital->Off_name : 'กรุณาตั้งค่าสถานพยาบาลที่สังกัด!' ?>"
            ...
            <div class="col-md-3 col-xs-12">
                <?= $form->field($model, 'prov')->textInput(['maxlength' => true, 'readonly' => true]) ?>
            </div>
